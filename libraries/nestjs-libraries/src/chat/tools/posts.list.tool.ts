...
Posts cannot be deleted through the Butterfly Social tools - if the user wants to delete a post, tell them to do it themselves in the Butterfly Social app; never offer to delete a post.
`,
