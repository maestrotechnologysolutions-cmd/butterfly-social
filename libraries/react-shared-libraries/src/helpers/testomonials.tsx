export const testimonials1 = [
  ...
  },
  {
    ...
    content: (
      <>
        I just found out about Butterfly Social, a tool for scheduling social media.{' '}
        {'\n'}
        ...
        {'\n'}
        Butterfly Social seems to focus on just doing one thing well. {'\n'}
        {'\n'}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        As a privacy-first company we appreciate being able to self-host Butterfly Social!
  ...
  },
  {
    ...
    content: (
      <>
        Butterfly Social changed how we manage our social media presence by aggregating
        our platforms into one effective tool. Post scheduling, and AI post
        ideation are two of the many features that come with Butterfly Social, and have
  ...
  },
  {
    ...
    content: (
      <>
        ...
        n8n + Butterfly Social =🔥Never miss a day of posting again: {'\n\n'}→ Easy to get
  ...
  },
  {
    ...
    content: (
      <>
        Manage all your social media accounts from a single place: Butterfly Social, a
...
export const testimonials2 = [
  {
    ...
    content: (
      <>
        🌟 Exciting news! 🚀 I've just started using Butterfly Social, a fantastic new
        tool for scheduling my social media content! {'\n\n'}
        Why did I choose Butterfly Social? The ability to self-host it means significant
        savings for me! 💰 {'\n\n'}
        Butterfly Social is an open-source scheduling tool that allows you to plan and
        ...
        scheduling! 📅✨ {'\n\n'}
        Built with privacy and flexibility in mind, Butterfly Social can run on your own
  ...
  },
  {
    ...
    content: (
      <>
        Butterfly Social makes it so easy to plan ahead. The AI suggestions are relevant,
