  ...
  return (
    <div className="flex flex-col text-textColor flex-1">
      <div className="flex-1 relative">
        <div className="grid [grid-template-columns:136px_repeat(7,_minmax(110px,_1fr))] gap-[4px] rounded-[10px] absolute h-full start-0 top-0 w-full overflow-x-auto overflow-y-auto scrollbar scrollbar-thumb-fifth scrollbar-track-newBgColor">
  ...
  return (
    <div className="flex flex-col text-textColor flex-1">
      <div className="flex-1 flex relative">
        <div className="grid [grid-template-columns:repeat(7,_minmax(110px,_1fr))] grid-rows-[62px_auto] gap-[4px] rounded-[10px] absolute start-0 top-0 overflow-x-auto overflow-y-auto w-full h-full scrollbar scrollbar-thumb-tableBorder scrollbar-track-secondary">
